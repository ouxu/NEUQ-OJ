...
class LoginAbout extends React.Component {
    ...
    refreshCaptcha(){
        ...
        this.setState({
            ...
            captchaflag: !this.state.captchaflag
        })
    ...
    render() {
        ...
        return (
            <div >
                ...
                <QueueAnim component="Form"  onSubmit={this.handleSubmit} type="bottom" className="register-wrap-form">
                    ...
                    >
                        <Row type="flex" >
                            ...
                            <Col>
                                <img src={this.state.captcha} alt='register-captcha' className="register-wrap-form-captcha" onClick={this.refreshCaptcha} key={this.state.captchaflag+1}/>
                    ...
                    <Row type="flex"  align="bottom"  key="register-9" className="register-wrap-form-footer">
                        ...
                        <Col xs={{span:24}} sm={{span:8}}>
                            <Button type="primary" htmlType="submit" size="large" disabled={!this.state.checkagreement}>点击注册</Button>
                        </Col>
                    </Row>
                </QueueAnim>
                </Card>
